...
const Header = () => {
  ...
  return (
   ...
   <div className='w-full px-16 py-2 bg-themeyellow lg:flex hidden justify-between items-center gap-6'>
    <h1 className='text-sm-font-semibold flex justify-center items-center'><FaPhoneVolume className='size-[18px]'/><span>+91 123 456 0789</span></h1>
    <h1 className='text-sm-font-semibold flex justify-center items-center'><FaMapMarkedAlt className='size-[18px]'/><span>Lorem ipsum dolor sit amet consectetur adipisicing elit. A, cum!</span></h1>
    <h1 className='text-sm-font-semibold flex justify-center items-center'><MdEmail className='size-[18px]'/><span>electrashop@company.com</span></h1>
    </div>
    <nav className='w-full bg-gray-100 flex justify-between items-center gap0-1 lg:px-16 px-6 py-5 sticky top-0 z-50'>
      ...
      <div id='header-icons' className='lg:flex hidden justify-center items-center gap-6 text-black'>
        ...
        <faShoppingCart classNamew='w-[20px] h-[20px] transform hover:scale-125 transition-transform duration-300 cursor-pointer hover:text-themepurple'/>
